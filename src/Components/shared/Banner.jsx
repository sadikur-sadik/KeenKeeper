...
const Banner = () => {
  ...
  return (
    <div className='max-w-277.5 w-11/12 mx-auto space-y-10 mt-20 pb-10 border-b border-b-gray-200'>
      ...
      <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6 rounded-md  lg:w-12/12 mx-auto'>
