    ...
    <div className='space-y-4'>
      ...
      <div className='border border-gray-200 p-6 space-y-4 rounded-md'>
        ...
        <div className='grid lg:grid-cols-3 grid-cols-1 gap-6 rounded-md w-11/12 lg:w-12/12 mx-auto'>
          <div onClick={() => handleInteraction("call", newFriend.name)} className='flex justify-center items-center flex-col gap-4 p-4 rounded-md bg-gray-100 border border-gray-200'>
            <FiPhoneCall /> <p>Call</p>
          </div>
          <div onClick={() => handleInteraction("text", newFriend.name) } className='flex justify-center items-center flex-col gap-4 p-4 rounded-md bg-gray-100 border border-gray-200'>
            <RiMessage2Line /> <p>Text</p>
          </div>
          <div onClick={() =>handleInteraction("video", newFriend.name)} className='flex justify-center items-center flex-col gap-4 p-4 rounded-md bg-gray-100 border border-gray-200'>
